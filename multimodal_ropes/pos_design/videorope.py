...
def get_videorope_index(
    ...
    extra_config: VideoRopeConfig = None,
    **kwargs,
) -> tuple[torch.Tensor, torch.Tensor]:
    """
    transformers==5.3.0-compatible `get_rope_index` for VideoRoPE on Qwen3-VL.

    This follows the official Qwen3-VL modality grouping and uses `temporal_stride` as a temporal spacing factor.
    """
