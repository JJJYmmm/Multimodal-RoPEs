...
def get_mrope_interleave_index(
    ...
    **kwargs,
    ...
    """
    transformers==5.3.0: Qwen3-VL uses `mm_token_type_ids` to group modalities.

    For `mrope-interleave` with `spatial_reset=False`, we should match the official Qwen3-VL get_rope_index behavior.
    """
