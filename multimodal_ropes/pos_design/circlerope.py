...
def get_circlerope_index(
    ...
    **kwargs,
    ...
    """
    transformers==5.3.0-compatible `get_rope_index` for CircleRoPE on Qwen3-VL.

    This repo's CircleRoPE variant primarily changes frequency allocation; we keep Qwen3-VL's
    modality grouping to ensure generation correctness.
    """
